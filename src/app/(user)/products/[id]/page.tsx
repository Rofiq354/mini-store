...
export default async function ProductDetailPage({
  ...
  // Ambil produk terkait (kategori yang sama, kecualikan produk ini)
  ...
  return (
    <div className="container mx-auto max-w-7xl px-4 py-8">
      ...
      >
        <Link href="/products">
          <ChevronLeft className="mr-2 h-4 w-4" /> Kembali ke Katalog
        </Link>
      </Button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col space-y-6">
          ...
          {/* Toko Info */}
          <Link
            href={`/stores/${product.profiles?.id}`}
          ...
          {/* Action Button (Akan butuh Client Component untuk Add to Cart) */}
          <Button
            size="lg"
